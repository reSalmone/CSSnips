    ...
    <div id="rest" onclick="closeLogin(); closeSignup();">
        ...
        ?>
                    <div class="contest-info-box">
                        <div class="contest-title"><?=$challenge_title?></div>
                        <div class="contest-content">
                            <div class="contest-content-title"><?= $name?></div>
                            <div class="contest-content-subtitle"><?=$challenge_description?></div>
                        </div>
        ...
        ?>
                                <div class="range">
                                    <div class="fill" id="fill" style="width:<?=$fill?>%;"></div>
                                </div>
        ...
        ?>
                                <div class="range">
                                    <div class="fill" id="fill" style="width:100%; background-color: var(--color5);"></div>
                                </div>
                                <p class="data-days" style="color: var(--color5);">Terminated <?=$diff->format('%a days ago')?></p>
        <?php
                            }
        ?>  
                            </div>
        <?php 
                            if($is_challenge_active){
        ?>
                            <button class="create-button" onclick="location.href ='creator.php?challenge=<?= urlencode($name)?>'">
                    ...
                    if ($dbcon != -1) { //se la connessione è correttamente stabilita
                        ...
                        while ($tuple = pg_fetch_array($result2, NULL, PGSQL_ASSOC)) {
                            ...
                            if (file_exists(__DIR__ . "\\snippets\\" . $fileLocation)) {
                                ...
                                elseif ($rank == 3 &&!$is_challenge_active) $color_rank="style='border: 2px solid sienna; box-shadow: 0px 0px 15px sienna;'";
                                else $color_rank= "";
        ?>
                                <div class="output-snip" <?=$color_rank?>>
                                    <div class= "snip-info">
        <?php
                                if ($is_challenge_active){
        ?>             
        ...
        ?>
                                                <input type='checkbox' data-snippet='<?=$snip_name?>' <?=$checkValue ?> class='snip-like-checkbox'>
        <?php
        ...
        ?>     
                                    ...
                                    <p class="info-like" id="data-liked-value-<?=$snip_name?>"><?=$snip_likes?></p>
        <?php
                                }
                                else{
        ...
        ?>
                                ...
                                <iframe id="output-snip-frame-<?=$snip_name ?>" class="output-preview"></iframe>
                                ...
                                <script id="snippet-data-<?=$snip_name?>" type="application/json">
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        assignIFrame("output-snip-frame-<?=$snip_name?>", data.html, data.css, data.js);
                                    });
                                </script>
                                <div class="info">
