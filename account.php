...
if ($dbcon != -1) { 
  ...
  if (($line1 = pg_fetch_array($result1, NULL, PGSQL_ASSOC)) && ($line2 = pg_fetch_array($result2, NULL, PGSQL_ASSOC)) && ($line3 = pg_fetch_array($result3, NULL, PGSQL_ASSOC)) && ($line4 = pg_fetch_array($result4, NULL, PGSQL_ASSOC))) {
    $found = true;
    $email = $line1['email'];
    $bio = $line1['bio'];
